...
O principal objetivo deste portfólio é apresentar de forma clara e objetiva:

* Minhas principais competências técnicas
* Projetos que desenvolvi ou participei
...
Você pode acessar a versão online hospedada em **GitHub Pages** (link disponível na aba de deploy do repositório, assim que finalizado).
...
* **Email:** [fabianognovais@email.com](mailto:fabianognovais@email.com)
